...
namespace Odin.Tests.Parsing
{
    ...
    public class MethodParameterTypeConversionTests
    {
        ...
        public void WithNullableBoolean_NoArgumentIdentifier()
        {
            ...
            result.MethodParameters[0].IsValueSet().ShouldBe(true);
        }
        ...
        public void WithStringArray()
        {
            ...
            // Then
            result.MethodParameters[0].Value.ShouldBe(new[] {"file1", "file2", "file3"});
            result.MethodParameters[1].Value.ShouldBe(42);
        }
        ...
        public void WithBoolArray()
        {
            ...
            // Then
            result.MethodParameters[0].Value.ShouldBe(new[] { true, false, true});
            result.MethodParameters[1].Value.ShouldBe(42);
        }
        ...
        public void WithNullableBoolArray()
        {
            ...
            result.MethodParameters[0].Value.ShouldBe(new[] { true, (bool?)null, false });
            result.MethodParameters[1].Value.ShouldBe(42);
        }
        ...
        public void WithInt32Array()
        {
            ...
            // Then
            result.MethodParameters[0].Value.ShouldBe(new[] { 4, 8, 15, 16, 28, 42 });
            result.MethodParameters[1].Value.ShouldBe(42);
        }
        ...
        public void WithNullableInt32Array()
        {
            ...
            // Then
            result.MethodParameters[0].Value.ShouldBe(new[] { 4, (int?)null, 15});
            result.MethodParameters[1].Value.ShouldBe(42);
        }
        ...
        public void WithDateTimeArray()
        {
            ...
            // Then
            result.MethodParameters[0].Value.ShouldBe(new[] { new DateTime(2015,1,1), new DateTime(2015,12,25),  });
            result.MethodParameters[1].Value.ShouldBe(42);
        }
        ...
        public void WithNullableDateTimeArray()
        {
            ...
            // Then
            result.MethodParameters[0].Value.ShouldBe(new[] { new DateTime(2016, 01, 01), (DateTime?)null, new DateTime(2016, 12, 25) });
            result.MethodParameters[1].Value.ShouldBe(42);
        }
        ...
        public void WithNullableDecimalArray()
        {
            ...
            // Then
            result.MethodParameters[0].Value.ShouldBe(new[] { 4, (decimal?)null, 15 });
            result.MethodParameters[1].Value.ShouldBe(42);
        }
        ...
        public void WithNullableDoubleArray()
        {
            ...
            // Then
            result.MethodParameters[0].Value.ShouldBe(new[] { 4, (double?)null, 15 });
            result.MethodParameters[1].Value.ShouldBe(42);
        }
        ...
        public void WithEnumArray()
        {
            ...
            // Then
            result.MethodParameters[0].Value.ShouldBe(new[] { Numbers.One, Numbers.Three, Numbers.Two});
            result.MethodParameters[1].Value.ShouldBe(42);
        }
    }
}
